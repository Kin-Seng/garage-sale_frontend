...
class SellingPosts extends Component {
  ...
  fetchMyPosts=()=>{
    ...
    axios.get(`https://localhost:5000/api/v1/selling_post/mySellingPost/${this.props.match.params.id}`,{  
      headers: {
  ...
  deletePost = (product_id) =>{
    axios.post(`https://localhost:5000/api/v1/selling_post/delete/${product_id}`,{  
